...
echo -e "\\ndefine Device/embedfire_lubancat-2n
  ...
  DEVICE_PACKAGES := kmod-r8125 kmod-ata-ahci
endef
TARGET_DEVICES += embedfire_lubancat-2n" >> target/linux/rockchip/image/armv8.mk
...
cp -f $GITHUB_WORKSPACE/configfiles/dts/rk3568/rk3568-lubancat-2.dts target/linux/rockchip/dts/rk3568/
cp -f $GITHUB_WORKSPACE/configfiles/dts/rk3568/rk3568-lubancat-2.dts target/linux/rockchip/files/arch/arm64/boot/dts/rockchip/
